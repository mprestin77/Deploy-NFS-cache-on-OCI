...
### Deployment
To deploy NFS cache on OCI provision an Oracle Linux compute instance using one of E4.DenseIO.Flex shape. Use of one available E4.DenseIO.Flex shapes available
